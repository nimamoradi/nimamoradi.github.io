...
Date: 2019-06-10
Tags: Python, Logistic Regression, Machine Learning, Classification, Scikit-learn
Category: Research
Summary: An example of logistic regression using python
Image: images/logistic-regression-line-example.jpg
Image_Fit: contain
...
![Sigmoid function diagram](../images/logistic-regression-sigmoid-curve.jpg)
